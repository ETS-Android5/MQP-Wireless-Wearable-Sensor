...
public class SDSDGraphActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sdsd);

        lineChart = findViewById(R.id.line_chart_sdsd);
    }
    ...
    protected void onResume() {
        ...
        getData(new IResponse<ArrayList<Map<String, Object>>>() {
            ...
            public void success(ArrayList<Map<String, Object>> data) {
                ...
                LineDataSet d1 = new LineDataSet(values1, "SDSD " + data.size() + ", (1)");
    ...
    private void getData(final IResponse<ArrayList<Map<String, Object>>> SDSD_response) {
        DatabaseReference SDSDList_list = FirebaseDatabase.getInstance().getReference().child("SDSDList");
        SDSDList_list.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                Iterable<DataSnapshot> SDSDList_children = dataSnapshot.getChildren();
                ArrayList<Map<String, Object>> mapList = new ArrayList<>();
                for (DataSnapshot child : SDSDList_children) {
