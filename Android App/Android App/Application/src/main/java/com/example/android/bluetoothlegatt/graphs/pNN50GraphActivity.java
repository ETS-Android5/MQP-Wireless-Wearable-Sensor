...
public class pNN50GraphActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pnn50);

        lineChart = findViewById(R.id.line_chart_pnn50);
    }
    ...
    protected void onResume() {
        ...
        getData(new IResponse<ArrayList<Map<String, Object>>>() {
            ...
            public void success(ArrayList<Map<String, Object>> data) {
                ...
                LineDataSet d1 = new LineDataSet(values1, "pNN50 " + data.size() + ", (1)");
    ...
    private void getData(final IResponse<ArrayList<Map<String, Object>>> pNN50_response) {
        DatabaseReference pNN50List_list = FirebaseDatabase.getInstance().getReference().child("pNN50List");
        pNN50List_list.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                Iterable<DataSnapshot> pNN50List_children = dataSnapshot.getChildren();
                ArrayList<Map<String, Object>> mapList = new ArrayList<>();
                for (DataSnapshot child : pNN50List_children) {
                ...
                pNN50_response.success(mapList);
            }
