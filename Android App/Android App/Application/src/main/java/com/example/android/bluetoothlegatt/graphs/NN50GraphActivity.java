...
public class NN50GraphActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nn50);

        lineChart = findViewById(R.id.line_chart_nn50);
    }
    ...
    protected void onResume() {
        ...
        getData(new IResponse<ArrayList<Map<String, Object>>>() {
            ...
            public void success(ArrayList<Map<String, Object>> data) {
                ...
                LineDataSet d1 = new LineDataSet(values1, "NN50 " + data.size() + ", (1)");
    ...
    private void getData(final IResponse<ArrayList<Map<String, Object>>> NN50_response) {
        DatabaseReference NN50List_list = FirebaseDatabase.getInstance().getReference().child("NN50List");
        NN50List_list.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                Iterable<DataSnapshot> NN50List_children = dataSnapshot.getChildren();
                ArrayList<Map<String, Object>> mapList = new ArrayList<>();
                for (DataSnapshot child : NN50List_children) {
